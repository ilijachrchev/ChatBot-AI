    ...
    <div className='flex flex-col gap-5 justify-center'>
        ...
        <div className='flex gap-10 flex-col sm:flex-row'>
            <div className='w-[300px]'>
                ...
                <CardDescription>
                    During this call, we aim to explore potential avenues for partnership,
                    promotional opportunities, or any other means through which we can contribute
                ...
                {APPOINTMENT_TIME_SLOTS.map((slot, key) => (
                    ...
                    >
                        <Card
                            ...
                            className={cn(
                                currentSlot == slot.slot ? 'bg-grandis' : 'bg-peach', 'px-10 py-4',
                                bookings &&
                                bookings.some(
                                    (booking) =>
