  ...
  return (
    <>
      <button
        ...
        className='lg:hidden fixed top-4 left-4 z-50 p-2.5 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg text-slate-900 dark:text-white hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors shadow-sm'
      >
      ...
      <aside
        className={cn(
          'fixed lg:sticky top-0 left-0 h-screen bg-white dark:bg-slate-950 border-r border-slate-200 dark:border-slate-800 z-50 transition-all duration-300 ease-out flex-shrink-0',
          collapsed ? 'w-20' : 'w-64',
            ...
            {!collapsed && (
              <div className='flex items-center gap-3'>
                <div className='w-10 h-10 rounded-xl bg-slate-900 dark:bg-white flex items-center justify-center'>
                  <Settings className='w-5 h-5 text-white dark:text-slate-900' />
                </div>
                <div>
            ...
            <div className='space-y-6'>
              {groups.map((group) => {
                ...
                return (
                  <div key={group}>
                    {!collapsed && (
                      <span className='text-[10px] font-medium uppercase tracking-widest text-slate-400 px-3 mb-1 block'>
                        {group}
                      </span>
                    )}
          ...
          {!collapsed && (
            <div className='p-4 border-t border-slate-200 dark:border-slate-800'>
              <div className='flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800'>
                <div className='w-10 h-10 rounded-full bg-slate-900 dark:bg-white flex items-center justify-center text-white dark:text-slate-900 font-semibold text-sm flex-shrink-0'>
