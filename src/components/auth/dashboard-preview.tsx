  ...
  return (
    ...
    >
      <div className="relative">
        <div className="relative w-full max-w-[500px] h-[400px] rounded-2xl bg-[var(--bg-surface)]/80 backdrop-blur-xl border border-white/10 overflow-hidden shadow-2xl">
            ...
            >
              {[40, 65, 45, 80, 55, 90, 70, 85].map((height, i) => (
                <motion.div
                  ...
                  className="w-6 rounded-t-md bg-[var(--primary)]"
                />
              ))}
            </motion.div>
            ...
            <div className="space-y-2">
              {[1, 2, 3].map((_, i) => (
                ...
                >
                  ...
                  <div className="h-6 w-16 bg-[var(--primary)]/20 rounded-md" />
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <motion.div
          ...
          className="absolute -top-6 -right-6 w-24 h-24 rounded-2xl bg-[var(--primary)]/10 backdrop-blur-sm border border-[var(--primary)]/20 flex items-center justify-center"
        >
        ...
        <motion.div
          ...
          className="absolute -bottom-4 -left-4 w-20 h-20 rounded-xl bg-[var(--primary)]/10 backdrop-blur-sm border border-[var(--primary)]/20 flex items-center justify-center"
        >
      ...
      <div className="absolute inset-0 -z-10 blur-3xl opacity-30">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full bg-[var(--primary)]" />
      </div>
    </motion.div>
  )
}
