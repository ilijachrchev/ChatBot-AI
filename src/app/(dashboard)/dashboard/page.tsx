        ...
        <div>
          <div>
            ...
            <p className='text-sm font-light'>
              A detailed overview of your metrcis, usage, customers and more.
            </p>
            <PlanUsage
              plan={plan?.plan! || 0}
          ...
          <div className='flex flex-col'>
            <div className='w-full flex justify-between items-startmb-5'>
            ...
            {transactions &&
              transactions.data.map((transaction) => (
                <div className='flex gap-3 w-full justify-between items-center border-b-2 py-5'
                key={transaction.id}>
